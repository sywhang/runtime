    ...
    internal sealed class RuntimeEventSource : EventSource
    {
        ...
        protected override void OnEventCommand(EventCommandEventArgs command)
        {
            if (command.Command == EventCommand.Enable)
            {
                ...
                _lastGen0GCTimeCounter ??= new PollingCounter("last-gen-0-duration", this, () => GC.GetGenerationLastGCDuration(0)) { DisplayName = "Last Gen 0 GC Pause Time", DisplayUnits = "ms" };
                _lastGen1GCTimeCounter ??= new PollingCounter("last-gen-1-duration", this, () => GC.GetGenerationLastGCDuration(1)) { DisplayName = "Last Gen 1 GC Pause Time", DisplayUnits = "ms" };
                _lastGen2GCTimeCounter ??= new PollingCounter("last-gen-2-duration", this, () => GC.GetGenerationLastGCDuration(2)) { DisplayName = "Last Gen 2 GC Pause Time", DisplayUnits = "ms" };
